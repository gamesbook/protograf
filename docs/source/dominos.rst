...
|do1| This example shows Domino objects constructed using these commands:
      ...
      assigned to be a ``diamond``, or a custom shape.

      The white dominoes in the lower-middle section show how the Domino, like
      many other shapes, can be assigned text captions, and that it can be
      rotated. The *stroke_width* of the rotated dominoes has also been made
      thicker.

      A domino can also be assigned *centre_line* and/or *centre_shape*
      properties; this can be seen in the one lower-middle right example.
