...
Rectangle(x=1, y=7.8, width=7.5, height=3, rounded=0.5, stroke="black", fill="black")
Rectangle(x=1.1, y=7.9, width=7.3, height=2.8, rounded=0.5, stroke_width=2, stroke="yellow", fill=None)
Sequence(
...
Circle(cx=2, cy=22, radius=1,
       ...
       radii=[135,225],
       radii_offset=0.5, radii_length=1, radii_stroke="white", radii_stroke_width=15)
