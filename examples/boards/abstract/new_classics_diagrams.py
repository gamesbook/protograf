...
black = Common(
    ...
    label_size=24, label_stroke="gold")
white = Common(
    radius=0.55,fill="white",stroke="#2E2E2E",stroke_width=2,
    label_size=24, label_stroke="gold")
lbl = Common(
    outlined=True,fill="red",wrap=True,width=1.75,height=1.75,font_size=28,stroke="white")
# boards
...
Layout(brd3,
       locations=[(2,1),(3,1),(2,2),(3,2),(1,3),(3,3)],
       shapes=[w1,w1,target,b1,b1B,w1])
Layout(brd4,
       locations=[(2,1),(3,1),(2,2),(3,2),(1,3),(3,3)],
       shapes=[b_y,b_y,b1,b1,b1,b_y])
# arrows
Line(x=1, y=8.6, angle=45, length=1.6, stroke="red", stroke_width=3, arrow_width=0.6)
Line(x=2.7, y=2.25, length=1.1, stroke="red", stroke_width=3, arrow_width=0.6)
# extras
Line(x=0, y=4.85, length=9.5, stroke="#BDBDBD", stroke_width=3, dotted=True)
