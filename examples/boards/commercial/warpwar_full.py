...
if SHOW_WARPLINES:
    # warp lines
    GridLine(ww_grid, locations=[("1C", 0.75, 0.2), ("8L", -0.6,  -0.1)], common=warp_line)
    GridLine(ww_grid, locations=[("1H", 0.0, -0.7), ("3G",  0.0,  0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("1O", 0.4, 0.5), ("3O", 0.0, 0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("2B", 0.3, -0.85), ("4B", -0.75, 0.8)], common=warp_line)
    GridLine(ww_grid, locations=[("2B", -0.5,  0.7), ("4E",  0.05, -0.9)], common=warp_line)
    GridLine(ww_grid, locations=[("2U", 0.6, -0.4), ("5V", -0.6, -0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("2W", 0.4, 0.6), ("5Z", -0.6, 0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("3O", 0.7, 0.0), ("5N", 0.3, -0.2)], common=warp_line)
    GridLine(ww_grid, locations=[("4E", 0.25, -1.05), ("4B", -0.6,  0.9)], common=warp_line)
    GridLine(ww_grid, locations=[("5N", 0.6, -0.60), ("9P", -0.4, -0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("5S", 0.7, 0.), ("8Q", 0.0, 0.6)], common=warp_line)
    GridLine(ww_grid, locations=[("5S", 0.6, 0.4), ("9Y", -0.5, -0.2)], common=warp_line)
    GridLine(ww_grid, locations=[("5V", 0.6, -0.3), ("9Y", -0.4, 0.2)], common=warp_line)
    GridLine(ww_grid, locations=[("5Z", 0.4, 0.3), ("9Y", -0.6, 0.9)], common=warp_line)
    GridLine(ww_grid, locations=[("7F", 0.5, 0.2), ("11F", -0.4, 0.3)], common=warp_line)
    GridLine(ww_grid, locations=[("8L", 0.4, 0.8), ("15S", -0.6, -0.8)], common=warp_line)
    GridLine(ww_grid, locations=[("8S", 0.5, 0.8), ("20CC", -0.4, -0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("9P", 0.4, -0.4), ("10P", -0.2, 0.6)], common=warp_line)
    GridLine(ww_grid, locations=[("9Y", 0.4, 0.5), ("14Y", -0.6, 0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("10L", 0.7, 0.0), ("13M", -0.0, -0.2)], common=warp_line)
    GridLine(ww_grid, locations=[("11F", 0.5, 0.2), ("15I", -0.4, -0.4)], common=warp_line)
    GridLine(ww_grid, locations=[("13M", 0.6, 0.0), ("17P", -0.4, -0.8)], common=warp_line)
    GridLine(ww_grid, locations=[("15I", 0.4, -0.5), ("19J", -0.7, -0.6)], common=warp_line)
    GridLine(ww_grid, locations=[("15I", -0.4, 0.4), ("13M", 0.4, -0.70)], common=warp_line)
    GridLine(ww_grid, locations=[("15S", 0.4, 0.5), ("18U", -0.4, -0.2)], common=warp_line)
    GridLine(ww_grid, locations=[("15S", -0.9, -0.1), ("8S", 0.7, -0.1)], common=warp_line)
    GridLine(ww_grid, locations=[("15S", -0.7, 0.2), ("20CC", 0.0, -0.8)], common=warp_line)
    GridLine(ww_grid, locations=[("16BB", 0.5, -0.8), ("20CC", -0.85, 0.1)], common=warp_line)
    GridLine(ww_grid, locations=[("17P", 0.6, -0.4), ("20Q", -0.95, 0.0)], common=warp_line)
    GridLine(ww_grid, locations=[("19W", 0.6, 0.1), ("20W", 0.1, 0.65)], common=warp_line)
